...
export const addDish = async (data) => {
  return await commonrequest("POST", `${BACKEND_URL}/user/dish`, data);
};
...
export const deleteDish = async (data) => {
  return await commonrequest("DELETE", `${BACKEND_URL}/user/deletedish`, data);
};
...
export const updatePrice = async (data) => {
  return await commonrequest("POST", `${BACKEND_URL}/user/updateprice`, data);
};
